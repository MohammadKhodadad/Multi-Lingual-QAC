...
\begin{figure}[t]
  ...
  \caption{Language-collapse diagnostics. Same-language documents are
  over-represented in retrieved lists, and same-language distractors can bury
  cross-language gold evidence.}
  \label{fig:app-language-collapse}
\end{figure}
