...
|---|---|---|---|---|---|---|---|---|---|
| de | 58 | 0.592 | 0.161 | 0.586 | 0.345 | 0.213 | 0.483 | 0.517 | 0.241 |
| en | 72 | 0.574 | 0.264 | 0.634 | 0.472 | 0.444 | 0.602 | 0.546 | 0.389 |
| fr | 68 | 0.475 | 0.225 | 0.515 | 0.338 | 0.211 | 0.436 | 0.343 | 0.176 |

##    MRR@10 by query language
| Group | n | BAAI/bge-m3 | cambridgeltl/SapBERT-UMLS-2020AB-all-lang-from-XLMR | google/embeddinggemma-300m | ibm-granite/granite-embedding-278m-multilingual | intfloat/multilingual-e5-large-instruct | nomic-ai/nomic-embed-text-v2-moe | Qwen/Qwen3-Embedding-0.6B | sentence-transformers/LaBSE |
|---|---|---|---|---|---|---|---|---|---|
| de | 58 | 0.645 | 0.234 | 0.586 | 0.336 | 0.500 | 0.610 | 0.563 | 0.287 |
| en | 72 | 0.646 | 0.314 | 0.608 | 0.455 | 0.558 | 0.644 | 0.554 | 0.362 |
| fr | 68 | 0.469 | 0.221 | 0.537 | 0.341 | 0.439 | 0.451 | 0.427 | 0.200 |

## 2) Recall@10 by question mode (technical vs semantic)
| Group | n | BAAI/bge-m3 | cambridgeltl/SapBERT-UMLS-2020AB-all-lang-from-XLMR | google/embeddinggemma-300m | ibm-granite/granite-embedding-278m-multilingual | intfloat/multilingual-e5-large-instruct | nomic-ai/nomic-embed-text-v2-moe | Qwen/Qwen3-Embedding-0.6B | sentence-transformers/LaBSE |
|---|---|---|---|---|---|---|---|---|---|
| technical | 100 | 0.460 | 0.277 | 0.460 | 0.267 | 0.233 | 0.437 | 0.387 | 0.273 |
| semantic | 98 | 0.633 | 0.163 | 0.701 | 0.514 | 0.361 | 0.585 | 0.551 | 0.272 |

## 3) Recall@10 by question strategy
| Group | n | BAAI/bge-m3 | cambridgeltl/SapBERT-UMLS-2020AB-all-lang-from-XLMR | google/embeddinggemma-300m | ibm-granite/granite-embedding-278m-multilingual | intfloat/multilingual-e5-large-instruct | nomic-ai/nomic-embed-text-v2-moe | Qwen/Qwen3-Embedding-0.6B | sentence-transformers/LaBSE |
|---|---|---|---|---|---|---|---|---|---|
| random | 51 | 0.608 | 0.261 | 0.654 | 0.399 | 0.301 | 0.490 | 0.471 | 0.261 |
| random_missing | 49 | 0.524 | 0.156 | 0.551 | 0.299 | 0.272 | 0.463 | 0.429 | 0.320 |
| random_existing | 50 | 0.467 | 0.180 | 0.473 | 0.353 | 0.273 | 0.453 | 0.427 | 0.207 |
| all | 48 | 0.583 | 0.285 | 0.639 | 0.507 | 0.340 | 0.639 | 0.549 | 0.306 |

## 4) Recall@10 by query origin (original vs synthetic-translation)
| Group | n | BAAI/bge-m3 | cambridgeltl/SapBERT-UMLS-2020AB-all-lang-from-XLMR | google/embeddinggemma-300m | ibm-granite/granite-embedding-278m-multilingual | intfloat/multilingual-e5-large-instruct | nomic-ai/nomic-embed-text-v2-moe | Qwen/Qwen3-Embedding-0.6B | sentence-transformers/LaBSE |
|---|---|---|---|---|---|---|---|---|---|
| original | 198 | 0.545 | 0.221 | 0.579 | 0.389 | 0.296 | 0.510 | 0.468 | 0.273 |
...
|---|---|---|---|---|---|---|---|---|
| same-language target | 0.702 | 0.313 | 0.697 | 0.434 | 0.626 | 0.672 | 0.631 | 0.293 |
| cross-language target | 0.467 | 0.174 | 0.520 | 0.366 | 0.131 | 0.429 | 0.386 | 0.263 |
