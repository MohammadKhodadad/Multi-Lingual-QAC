...
|---|---|---|---|---|---|---|---|---|---|
| de | 27 | 0.052 | 0.051 | 0.076 | 0.064 | 0.030 | 0.059 | 0.060 | 0.053 |
| en | 27 | 0.060 | 0.057 | 0.085 | 0.054 | 0.047 | 0.072 | 0.073 | 0.071 |
| es | 25 | 0.057 | 0.025 | 0.092 | 0.056 | 0.022 | 0.065 | 0.065 | 0.043 |
| fr | 27 | 0.063 | 0.056 | 0.080 | 0.062 | 0.029 | 0.046 | 0.060 | 0.053 |
| zh | 26 | 0.038 | 0.058 | 0.071 | 0.044 | 0.017 | 0.043 | 0.063 | 0.059 |

##    MRR@10 by query language
| Group | n | BAAI/bge-m3 | cambridgeltl/SapBERT-UMLS-2020AB-all-lang-from-XLMR | google/embeddinggemma-300m | ibm-granite/granite-embedding-278m-multilingual | intfloat/multilingual-e5-large-instruct | nomic-ai/nomic-embed-text-v2-moe | Qwen/Qwen3-Embedding-0.6B | sentence-transformers/LaBSE |
|---|---|---|---|---|---|---|---|---|---|
| de | 27 | 0.753 | 0.316 | 0.678 | 0.630 | 0.431 | 0.736 | 0.605 | 0.527 |
| en | 27 | 0.800 | 0.558 | 0.706 | 0.659 | 0.685 | 0.827 | 0.830 | 0.599 |
| es | 25 | 0.710 | 0.374 | 0.823 | 0.564 | 0.277 | 0.822 | 0.728 | 0.518 |
| fr | 27 | 0.728 | 0.512 | 0.751 | 0.585 | 0.589 | 0.712 | 0.819 | 0.606 |
| zh | 26 | 0.515 | 0.441 | 0.673 | 0.409 | 0.254 | 0.350 | 0.665 | 0.572 |
...
|---|---|---|---|---|---|---|---|---|
| same-language target | 0.125 | 0.081 | 0.131 | 0.112 | 0.174 | 0.142 | 0.101 | 0.091 |
| cross-language target | 0.046 | 0.043 | 0.077 | 0.050 | 0.009 | 0.047 | 0.057 | 0.054 |
